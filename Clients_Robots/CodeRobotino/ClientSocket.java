...
import org.json.*;
/*Classe permettant de cr�er un client sur le robot pour la communication avec le serveur*/
public class ClientSocket {
	...
	public void connect(String name){
		try {
			...
			outToServer.write(b, 0, this.name.length());
			outToServer.flush();
	...
	//retourne un string au format json {"robot":"nomRobot","ordre":"ordreAEffectuer"}
